...
class CentralCorridor(Scene):
    def enter(self):
        ...
        print 'escape pod.'
        print '\n'
        print 'You\'re running down the central corridor to the Weapons Armony when'
        print 'a Gothon jumps out, red scaly skin, dark grimy teeth, and evil clown costume'
        print "flowing around his hate filled body. He's blocking the door to the"
        print 'Armory and about to pull a weapon to blast you.'

        print 'Which action you would take? (1) shoot! (2) dodge! or (3) tell a joke'
        action = raw_input('> ')
...
class LaserWeaponArmory(Scene):
    def enter(self):
        ...
        print 'get the bomb. The code is 4 digits.'
        # code = '{0}{1}{2}{3}'.format(randint(1, 9), randint(1, 9), randint(1, 9), randint(1, 9))
        code = '0715'
...
class TheBridge(Scene):
    def enter(self):
        ...
        print '(1) throw the bomb, or (2) slowly place the bomb?'
        action = raw_input('> ')
